...
const Post = () => {
  return (
    <div className="p-5 bg-white rounded-xl flex flex-col gap-4 text-base">
      <div className="flex justify-between w-full">
        <div className="flex gap-3 items-center">
          <Avatar/>
          <span>React</span>
          <span className="text-sm text-gray-500">11.05.2023</span>
        </div>
        <button className="py-1 px-5 bg-my-green-200 text-white rounded-xl hover:bg-my-green-300 duration-200">Подписаться</button>
      </div>
      <p>
        Мы собрали для вас подборку свежих и актуальных книг, по
        всем языкам программирования.В подборке не просто новые книги
        для программистов, но и те книги, которые дают практическую
        основу с задачами и решениями для получения реального полезных навыков.
      </p>
      <Link
        to={`${process.env.PUBLIC_URL}/post/1`}
